# How Do I Contribute to the InnerSource Working Group?
...
sequenceDiagram
  participant You
  participant WG as InnerSource Working Group
...
go in the [InnerSource Working Group GDrive]. Be sure to attribute all the
contributors to the resulting work (e.g., in the _Authors_ or
_Acknowledgements_ sections of Patterns).

To contribute, get access to the board by [joining the InnerSource Working Group team].
...
[joining the InnerSource Working Group team]: https://github.com/InnerSourceCommons/innersource-working-group/issues/new/choose
...
[InnerSource Working Group GDrive]: https://drive.google.com/drive/folders/1zhP_wQQFf1cIHnkTUZtBGuLhEUYXzvlC
